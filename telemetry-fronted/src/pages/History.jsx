...
export default function History() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto space-y-8 w-full">
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
        ...
        <div className="flex gap-3">
          <div className="bg-surface-container-high px-4 py-2 rounded-lg border border-border-theme shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-surface-container p-6 rounded-2xl border border-border-theme hover:border-primary/30 transition-all shadow-lg">
        ...
        <div className="bg-surface-container p-6 rounded-2xl border border-border-theme hover:border-secondary/30 transition-all shadow-lg">
          <p className="font-label text-[10px] font-bold tracking-[0.2em] text-outline uppercase mb-4">
        ...
        {/* Log Count Card */}
        <div className="bg-surface-container p-6 rounded-2xl border border-border-theme shadow-lg border border-border-theme">
          <p className="font-label text-[10px] font-bold tracking-[0.2em] text-outline uppercase mb-4">
      ...
      <div className="bg-surface-container rounded-2xl border border-border-theme overflow-hidden shadow-2xl">
        <div className="p-4 md:p-8 border-b border-border-theme flex flex-col xl:flex-row xl:items-center justify-between gap-6">
          <div>
            <h3 className="font-headline text-xl font-bold tracking-tight text-on-surface">RECENT TELEMETRY LOGS</h3>
            <p className="text-xs text-outline mt-1 uppercase tracking-widest">⬇Newest data at the top</p>
          </div>
          
          <div className="flex flex-wrap items-center gap-4">
            {/* Dynamic DB load limit */}
            <div className="flex items-center gap-2 bg-surface-container-high px-4 py-2.5 rounded-xl border border-border-theme shadow-inner">
              ...
              <select
                ...
                className="bg-surface-container text-on-surface px-3 py-1 rounded-lg text-xs border border-border-theme outline-none font-bold cursor-pointer hover:border-white/20 transition-all"
              >
        ...
        <div className="p-5 border-t border-border-theme bg-surface-container-low flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Show Entries Dropdown */}
          <div className="flex items-center gap-2.5 text-xs text-outline bg-surface-container-high px-3 py-1.5 rounded-lg border border-border-theme shadow-inner">
            <span>Show</span>
            <select
              ...
              className="bg-surface-container text-on-surface px-2.5 py-1 rounded-md border border-border-theme outline-none font-bold cursor-pointer hover:border-white/20 transition-all text-xs"
            >
          ...
          <div className="flex items-center gap-4 flex-wrap justify-center">
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="px-2.5 py-1.5 bg-surface-container hover:bg-surface-container-high text-on-surface text-xs rounded-lg border border-border-theme disabled:opacity-30 disabled:hover:bg-surface-container font-black transition-all cursor-pointer"
                title="First Page"
              >
                &lt;&lt;
              </button>
              <button
                ...
                disabled={currentPage === 1 || totalPages === 0}
                className="px-3.5 py-1.5 bg-surface-container hover:bg-surface-container-high text-on-surface text-xs rounded-lg border border-border-theme disabled:opacity-30 disabled:hover:bg-surface-container font-black transition-all cursor-pointer"
                title="Previous Page"
              >
                &lt;
              </button>
              <span className="text-xs text-outline px-2.5 select-none">
                Page <span className="font-bold text-on-surface font-mono">{currentPage}</span> of <span className="font-bold text-on-surface font-mono">{totalPages || 1}</span>
              </span>
              <button
            ...
            {totalPages > 1 && (
              <form
                ...
                className="flex items-center gap-1.5 bg-surface-container-high px-2 py-1 rounded-lg border border-border-theme shadow-inner"
              >
                ...
                <input
                  ...
                  className="w-12 bg-surface-container text-on-surface px-2 py-0.5 rounded text-xs border border-border-theme outline-none text-center font-mono font-bold"
                />
                <button
                  type="submit"
